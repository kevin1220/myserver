...
function jssdk(shareOpenid) {
    ...
    wx.ready(function() {
        wx.onMenuShareTimeline({
            title: '10万现金红包，租借你的朋友圈', // 分享标题
            link: 'http://www.wit-orange.com/appa?app=hbzl&bymp=false&shareOpenid=' + shareOpenid, // 分享链接
            imgUrl: 'http://www.wit-orange.com/hbzl/images/shareimg.jpg', // 分享图标
            success: function() {
                // 用户确认分享后执行的回调函数
                history.go(0);
            },
