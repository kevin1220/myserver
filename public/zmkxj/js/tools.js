...
function jssdk() {
    ...
    wx.ready(function() {
        wx.onMenuShareTimeline({
            title: '碧桂园&滴滴快车 “最美开学季”', // 分享标题
            link: 'http://www.wit-orange.com/zmkxj', // 分享链接
            imgUrl: 'http://www.wit-orange.com/zmkxj/images/shareimg.jpg', // 分享图标
            success: function() {
                // 用户确认分享后执行的回调函数
                history.go(0);
            },
