...
function jssdk() {
    ...
    wx.ready(function() {
        wx.onMenuShareTimeline({
            title: '舌尖艺术首秀金沙洲', // 分享标题
            link: 'http://www.wit-orange.com/tongueart', // 分享链接
            imgUrl: 'http://www.wit-orange.com/tongueart/images/shareimg.jpg', // 分享图标
            success: function() {
                // 用户确认分享后执行的回调函数
                history.go(0);
            },
