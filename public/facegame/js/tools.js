...
function jssdk() {
    ...
    wx.ready(function() {
        wx.onMenuShareTimeline({
            title: '打了100000+人的脸，你敢来试试吗？', // 分享标题
            link: 'http://www.wit-orange.com/facegame', // 分享链接
            imgUrl: 'http://www.wit-orange.com/facegame/img/shareimg.png', // 分享图标
            success: function() {
                // 用户确认分享后执行的回调函数
                history.go(0);
            },
        ...
        wx.onMenuShareAppMessage({
            title: '打了100000+人的脸，你敢来试试吗？', // 分享标题
            desc: '会玩！你和美颜之间的距离就差这个测试！', // 分享描述
            link: 'http://www.wit-orange.com/facegame', // 分享链接
            imgUrl: 'http://www.wit-orange.com/facegame/images/shareimg.png', // 分享图标
